// ARIKA v195 - main script externalized to avoid JavaScript text appearing in page
        ...
        window.renderDashboardPegawai = function(options = {}) {
            ...
            const monthVal = monthEl ? getManualMonthValueById('pegawai-dashboard-month', getCurrentMonth()) : getCurrentMonth();
...
(function(){
  ...
  function install(){
    installLoaderGuard();
    installChartLazyGuard();
    installHeavyRenderScheduler();
    installNavFlush();

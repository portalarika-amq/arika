        ...
        function renderPersonalHistoryPage() {
            ...
            tbody.innerHTML = rows.map(d => {
                ...
                return `<tr class="arika-archive-row hover:bg-slate-50/80">
                    ...
                    <td class="p-3 text-center"><span class="arika-archive-category">${escapeHTML(category)}</span></td>
...
(function(){
  ...
  function injectArchiveCss(){
    ...
    style.textContent = `
      ...
      .arika-archive-category{ display:inline-flex; align-items:center; justify-content:center; padding:.3rem .55rem; border-radius:999px; background:#f8fafc; border:1px solid #e2e8f0; color:#475569; font-weight:900; font-size:.56rem; text-transform:uppercase; letter-spacing:.08em; }

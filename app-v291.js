...
(function(){
  ...
  window.refreshWfhWfaData = async function(){
    try {
      ...
      if(typeof window.fetchCloudData === 'function') await window.fetchCloudData({ force:true, full:true });
  ...
  if(typeof oldNav === 'function' && !oldNav.__arikaV273Wfh){
    const wrapped = function(id){
      ...
      if(id === 'wfh') setTimeout(function(){ if(window.refreshWfhWfaData) window.refreshWfhWfaData(); else window.renderWfhWfaDay(); }, 80);
      return res;
    };

...
(function(){
  ...
  function release(reason){
    ...
    try{
      hideTransient();
      document.documentElement.classList.remove('arika-v311-boot');
      document.documentElement.classList.add('arika-v311-ready');
  ...
  setTimeout(function(){ if(!released && viewStable()) release('late-stable'); }, isMobile()?3200:2600);
  setTimeout(function(){ if(!released) release('failsafe'); }, isMobile()?6500:5200);
})();

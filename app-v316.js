...
// ARIKA v195 - main script externalized to avoid JavaScript text appearing in page
        ...
        function loginSetup(p, adminFlag) {
            ...
            if (adminFlag) {
                ...
                if(welcomeSubtitle) {
                    welcomeSubtitle.innerText = 'Kerja kerasmu berharga. ARIKA siap abadikan setiap progresmu hari ini. Semangat!';
                }
        ...
        window.simpanRencanaPribadi = async function(e) {
            ...
            try {
                ...
                [2500, 9000].forEach((delay) => setTimeout(() => {
...
(function(){
  ...
  window.addEventListener('load', function(){ restoreLinked(); setTimeout(enrichRencanaButtons, 400); });
  ...
  setTimeout(enrichRencanaButtons, 1200);
})();

...
// ARIKA v195 - main script externalized to avoid JavaScript text appearing in page
        ...
        window.renderRencanaPribadi = function() {
            ...
            const moreInfo = list.length > 3 ? `<div class="p-3 rounded-2xl bg-slate-50 border border-slate-100 text-center text-[10px] font-black uppercase tracking-widest text-slate-400">Menampilkan 3 rencana teratas dari ${list.length} rencana aktif.</div>` : '';

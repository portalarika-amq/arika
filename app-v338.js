...
/* =========================================================
   v338 - PC Rencana Live Sync After Mobile Input
    ...
    try{
      ...
      if(data && Array.isArray(data.rencana)){
        ...
        if(after !== before || berandaVisible()){
          try { window.renderRencanaPribadi && window.renderRencanaPribadi({source:'v338-pc-rencana-live-'+(reason||'sync')}); } catch(_) {}

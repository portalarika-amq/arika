/* =========================================================
   ARIKA v422 - Performance Stage 4 DOM Load Reduction
   Tujuan: mengurangi beban DOM/browser dengan progressive DOM,
   bukan merender/menahan ratusan card/baris sekaligus.
   ========================================================= */
(function(){
  'use strict';
  if(window.__ARIKA_DOM_V422__) return;
  window.__ARIKA_DOM_V422__ = true;

  var VERSION = 'v422-stage4-dom-reduction';
  var DEFAULT_STEP = 20;
  var pending = false;
  var observer = null;
  var applying = false;
  ...
  function log(){ try{ console.info.apply(console, ['ARIKA v422 DOM'].concat([].slice.call(arguments))); }catch(_){} }
  function warn(){ try{ console.warn.apply(console, ['ARIKA v422 DOM'].concat([].slice.call(arguments))); }catch(_){} }
  function idle(fn){
  ...
  function compactAll(reason){
    nextFrame(function(){
      ...
      document.documentElement.setAttribute('data-arika-dom-stage', 'v422');
    });
  }
  ...
  function wrapRender(name){
    ...
    window[name].__arikaV422DomWrapped = true;
    wrapped[name] = true;
    return true;
  }
  ...
  function injectCss(){
    if(document.getElementById('arika-dom-v422-style')) return;
    var style = document.createElement('style');
    style.id = 'arika-dom-v422-style';
    style.textContent = [

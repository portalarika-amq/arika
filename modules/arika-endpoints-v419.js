/* =========================================================
   ARIKA v419 - Performance Stage 3 Frontend Endpoint Bridge
...
(function(){
  'use strict';
  if(window.__ARIKA_ENDPOINTS_V419__) return;
  window.__ARIKA_ENDPOINTS_V419__ = true;
  var VERSION = 'v419-stage3-endpoint-bridge';
  var inflight = Object.create(null);
  var cache = Object.create(null);
  var CACHE_TTL = 35 * 1000;
  function warn(){ try{ console.warn.apply(console, ['ARIKA v419 endpoints'].concat([].slice.call(arguments))); }catch(_){} }
  function info(){ try{ console.info.apply(console, ['ARIKA v419 endpoints'].concat([].slice.call(arguments))); }catch(_){} }
  ...
  function mapJurnal(rows){
    ...
    return rows.map(function(r, idx){
      return {
        id: String(getVal(r, ['ID Jurnal','id','id_jurnal']) || 'kegiatan-v419-'+idx),
        date: dateOfJurnal(r),
  ...
  function mapRencana(rows){
    ...
    return rows.map(function(r, idx){
      var obj = {
        id: String(getVal(r, ['id','ID','id_rencana','ID Rencana']) || 'rencana-v419-'+idx),
  ...
  function wrapForceSync(){
    if(window.forceSyncFromSheet && !window.forceSyncFromSheet.__arikaV419EndpointWrapped){
      ...
      window.forceSyncFromSheet = async function(options){
        ...
        if(!options || !options.full){
          try{
            ...
            if(window.arikaRouteRender) window.arikaRouteRender(tab || 'beranda', { source:'force-light-v419' });
      ...
      window.forceSyncFromSheet.__arikaV419EndpointWrapped = true;
    }
  }
  function init(){
    wrapForceSync();

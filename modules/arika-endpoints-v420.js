/* =========================================================
   ARIKA v420 - Performance Stage 3 Frontend Endpoint Bridge
...
(function(){
  'use strict';
  if(window.__ARIKA_ENDPOINTS_V420__) return;
  window.__ARIKA_ENDPOINTS_V420__ = true;
  var VERSION = 'v420-stage3-endpoint-bridge';
  var inflight = Object.create(null);
  var cache = Object.create(null);
  var CACHE_TTL = 35 * 1000;
  function warn(){ try{ console.warn.apply(console, ['ARIKA v420 endpoints'].concat([].slice.call(arguments))); }catch(_){} }
  function info(){ try{ console.info.apply(console, ['ARIKA v420 endpoints'].concat([].slice.call(arguments))); }catch(_){} }
  ...
  function mapJurnal(rows){
    ...
    return rows.map(function(r, idx){
      return {
        id: String(getVal(r, ['ID Jurnal','id','id_jurnal']) || 'kegiatan-v420-'+idx),
        date: dateOfJurnal(r),
  ...
  function mapRencana(rows){
    ...
    return rows.map(function(r, idx){
      var obj = {
        id: String(getVal(r, ['id','ID','id_rencana','ID Rencana']) || 'rencana-v420-'+idx),
  ...
  function wrapForceSync(){
    if(window.forceSyncFromSheet && !window.forceSyncFromSheet.__arikaV420EndpointWrapped){
      ...
      window.forceSyncFromSheet = async function(options){
        ...
        if(!options || !options.full){
          try{
            ...
            if(window.arikaRouteRender) window.arikaRouteRender(tab || 'beranda', { source:'force-light-v420' });
      ...
      window.forceSyncFromSheet.__arikaV420EndpointWrapped = true;
    }
  }
  function init(){
    wrapForceSync();

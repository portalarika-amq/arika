/* =========================================================
   ARIKA v422 - Performance Stage 3 Frontend Endpoint Bridge
...
(function(){
  'use strict';
  if(window.__ARIKA_ENDPOINTS_V422__) return;
  window.__ARIKA_ENDPOINTS_V422__ = true;
  var VERSION = 'v422-stage3-endpoint-bridge';
  var inflight = Object.create(null);
  var cache = Object.create(null);
  var CACHE_TTL = 35 * 1000;
  function warn(){ try{ console.warn.apply(console, ['ARIKA v422 endpoints'].concat([].slice.call(arguments))); }catch(_){} }
  function info(){ try{ console.info.apply(console, ['ARIKA v422 endpoints'].concat([].slice.call(arguments))); }catch(_){} }
  ...
  function mapJurnal(rows){
    ...
    return rows.map(function(r, idx){
      return {
        id: String(getVal(r, ['ID Jurnal','id','id_jurnal']) || 'kegiatan-v422-'+idx),
        date: dateOfJurnal(r),
  ...
  function mapRencana(rows){
    ...
    return rows.map(function(r, idx){
      var obj = {
        id: String(getVal(r, ['id','ID','id_rencana','ID Rencana']) || 'rencana-v422-'+idx),
  ...
  function wrapForceSync(){
    if(window.forceSyncFromSheet && !window.forceSyncFromSheet.__arikaV422EndpointWrapped){
      ...
      window.forceSyncFromSheet = async function(options){
        ...
        if(!options || !options.full){
          try{
            ...
            if(window.arikaRouteRender) window.arikaRouteRender(tab || 'beranda', { source:'force-light-v422' });
      ...
      window.forceSyncFromSheet.__arikaV422EndpointWrapped = true;
    }
  }
  function init(){
    wrapForceSync();

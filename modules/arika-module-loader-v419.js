/* =========================================================
   ARIKA v419 - Modular Frontend Loader
   Tahap 3: frontend modular diarahkan ke endpoint ringan Apps Script v37.
...
(function(){
  'use strict';
  var VERSION = 'v419-stage3-endpoint-front';
  var BASE = './modules/';
  var loaded = Object.create(null);
  var loading = Object.create(null);
  var manifest = {
    performance: { file: 'arika-performance-v419.js', eager: true },
    api:         { file: 'arika-api-v419.js', eager: true },
    endpoints:   { file: 'arika-endpoints-v419.js', eager: true },
    router:      { file: 'arika-render-router-v419.js', eager: true },
    wfh:         { file: 'arika-wfh-v419.js', route: 'wfh' },
    admin:       { file: 'arika-admin-v419.js', route: 'admin' },
    rencana:     { file: 'arika-rencana-v419.js', route: 'rencana' },
    reminder:    { file: 'arika-reminder-v419.js' }
  };
  function log(){ try{ console.info.apply(console, ['ARIKA v419'].concat([].slice.call(arguments))); }catch(_){} }
  function warn(){ try{ console.warn.apply(console, ['ARIKA v419'].concat([].slice.call(arguments))); }catch(_){} }
  function load(name){
    ...
    loading[name] = new Promise(function(resolve, reject){
      ...
      s.src = BASE + manifest[name].file + '?v=419';
      s.defer = true;
      s.onload = function(){
        loaded[name] = true;
        try{
  ...
  function wrapNav(){
    if(typeof window.nav !== 'function' || window.nav.__arikaV419ModuleWrapped) return;
    var old = window.nav;
    ...
    window.nav.__arikaV419ModuleWrapped = true;
  }

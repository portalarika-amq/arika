/* =========================================================
   ARIKA v421 - Modular Frontend Loader
...
(function(){
  'use strict';
  var VERSION = 'v421-wfh-monthly-list';
  var BASE = './modules/';
  var loaded = Object.create(null);
  var loading = Object.create(null);
  var manifest = {
    performance: { file: 'arika-performance-v421.js', eager: true },
    api:         { file: 'arika-api-v421.js', eager: true },
    endpoints:   { file: 'arika-endpoints-v421.js', eager: true },
    router:      { file: 'arika-render-router-v421.js', eager: true },
    dom:         { file: 'arika-dom-v421.js', eager: true },
    wfh:         { file: 'arika-wfh-v421.js', route: 'wfh' },
    admin:       { file: 'arika-admin-v421.js', route: 'admin' },
    rencana:     { file: 'arika-rencana-v421.js', route: 'rencana' },
    reminder:    { file: 'arika-reminder-v421.js' }
  };
  function log(){ try{ console.info.apply(console, ['ARIKA v421'].concat([].slice.call(arguments))); }catch(_){} }
  function warn(){ try{ console.warn.apply(console, ['ARIKA v421'].concat([].slice.call(arguments))); }catch(_){} }
  function load(name){
    ...
    loading[name] = new Promise(function(resolve, reject){
      ...
      s.src = BASE + manifest[name].file + '?v=421';
      s.defer = true;
      s.onload = function(){
        loaded[name] = true;
        try{
  ...
  log('loader aktif. WFH/WFA memakai rekap bulanan stabil tanpa kalender.');
})();

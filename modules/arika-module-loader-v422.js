/* =========================================================
   ARIKA v422 - Modular Frontend Loader
...
(function(){
  'use strict';
  var VERSION = 'v422-wfh-monthly-list-anti-flicker';
  var BASE = './modules/';
  ...
  var manifest = {
    ...
    wfh:         { file: 'arika-wfh-v422.js', route: 'wfh' },
  ...
  function log(){ try{ console.info.apply(console, ['ARIKA v422'].concat([].slice.call(arguments))); }catch(_){} }
  function warn(){ try{ console.warn.apply(console, ['ARIKA v422'].concat([].slice.call(arguments))); }catch(_){} }
  function load(name){
    ...
    loading[name] = new Promise(function(resolve, reject){
      ...
      s.src = BASE + manifest[name].file + '?v=422';
      s.defer = true;
      s.onload = function(){
        loaded[name] = true;
        try{
  ...
  log('loader aktif. WFH/WFA memakai rekap bulanan stabil anti-flicker tanpa kalender.');
})();

/* ARIKA v420 - Reminder lazy module */
(function(){
  'use strict';
  if(window.__ARIKA_REMINDER_MODULE_V420__) return;
  window.__ARIKA_REMINDER_MODULE_V420__ = true;
  function fixReminderLayer(){
    var st = document.getElementById('arika-v420-reminder-layer-fix');
    if(!st){
      st = document.createElement('style');
      st.id = 'arika-v420-reminder-layer-fix';

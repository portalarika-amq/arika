/* ARIKA v421 - Reminder lazy module */
(function(){
  'use strict';
  if(window.__ARIKA_REMINDER_MODULE_V421__) return;
  window.__ARIKA_REMINDER_MODULE_V421__ = true;
  function fixReminderLayer(){
    var st = document.getElementById('arika-v421-reminder-layer-fix');
    if(!st){
      st = document.createElement('style');
      st.id = 'arika-v421-reminder-layer-fix';

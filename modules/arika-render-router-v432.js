/* ARIKA v432 - Active tab render router dengan WFH non-force agar tidak flicker */
(function(){
  'use strict';
  var timers = Object.create(null);
  function safe(fn){ try{ return fn(); }catch(e){ console.warn('ARIKA v432 router:', e); } }
  ...
  async function syncEndpoint(id){
    ...
    if(window.arikaSyncEndpointForTab) {
      ...
      catch(e){ console.warn('ARIKA v432 endpoint ringan gagal:', id, e); }
    }
    return null;
  }
  ...
  window.arikaInitModule_router = function(){ if(window.arikaRenderActiveTabOnly) window.arikaRenderActiveTabOnly('router-init-v432'); };
})();
